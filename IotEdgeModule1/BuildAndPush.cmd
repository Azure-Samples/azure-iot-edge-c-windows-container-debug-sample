...
echo Build project...
msbuild IotEdgeModule1.vcxproj /p:Configuration="Debug" /p:Platform="x64" /p:OutDir=output

echo Building container...
docker build -t %DockerImageName% --build-arg VS_REMOTE_DEBUGGER_PATH=%LOCAL_BIN_STAGING_DIR% -f Dockerfile.windows-amd64.debug .
